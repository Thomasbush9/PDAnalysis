...
* `--path_list` :: Path to a .txt file containing protein paths. Allowed inputs types: .pdb, .cif, .npy, .txt. If multiple files .txt are passed it will be computed the average like the original method.
